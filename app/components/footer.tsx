            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-3 font-manrope text-[18px]">
                        {dict.item_1.list.map((item: any, index: number) => (
                            <li key={index}>
                                <a href={item.link} className="hover:text-yellow-500 transition">{item.text}</a>
                            </li>
                        ))}
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-3">
                        <a href="#"
                           className="w-10 h-10 border border-gray-500 rounded flex items-center justify-center hover:translate-y-[5px] hover:border-[#CBA456] transition">
                ...
                <div>
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-[#CBA456]">{dict.item_4.address}</p>
                        </div>
                        <div>
