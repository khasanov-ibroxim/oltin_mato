            ...
            <div className=" mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ">
                    ...
                    <motion.div
                        ...
                        <button
                            className="bg-[#162C43] hover:bg-[#5A5A5A] text-black hover:text-white cursor-pointer font-semibold py-2  px-8 rounded-lg flex items-center gap-2 w-fit transition">
                            All Team
                    ...
                    {teamMembers.map((member, index) => (
                        <div key={index} className="relative h-[400px] rounded-3xl overflow-hidden group">
                            ...
                            <div className="absolute top-2 left-2 flex flex-col gap-3">
                                <a href="#"
                                   className="w-8 h-8 bg-[#162C43] hover:bg-[#5A5A5A] rounded-lg flex items-center justify-center transition">
