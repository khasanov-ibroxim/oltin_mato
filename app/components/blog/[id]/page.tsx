                        ...
                        <div className="border-t border-b border-gray-200 py-6 flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex gap-2">
                                    <Link href="#" className="w-8 h-8 rounded bg-[#5A5A5A] hover:bg-[#CBA655] flex items-center justify-center transition">
                                    ...
                                    {relatedBlogs.map((relatedBlog) => (
                                        ...
                                        >
                                            <div className="flex gap-3">
                                                ...
                                                <div>
                                                    <h4 className="font-dm font-bold text-sm text-[#222222] group-hover:text-[#CBA655] transition line-clamp-2">
                                                        {relatedBlog.title}
                                                    </h4>
